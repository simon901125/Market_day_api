...
public abstract class AdminServiceBase {
    ...
    /** 取得管理員後台: 活動搜尋 */
    public abstract PageResponse<AdminEventListDto> getEventsList(AdminEventSearchDto request, int pageNumber,
            int pageSize);
    ...
    /** 取得管理員後台: 使用者搜尋 */
    public abstract PageResponse<AdminUserListDto> getUserList(AdminUserSearchDto request, int pageNumber,
            int pageSize);
    ...
    /** 取得管理員後台: 攤主詳細: 活動報名紀錄 */
    public abstract PageResponse<AdminVenderRegDto> getVenderRegLogs(@Nonnull Long userId, int pageNumber,
            int pageSize);
    ...
    public abstract PageResponse<AdminOrgEventManagementDto> getOrgEventLogs(@Nonnull Long userId, int pageNumber,
            int pageSize);

    /** 取得管理員後台: 使用者詳細 :使用者登入紀錄 */
    public abstract PageResponse<AdminUserLoginDto> getUserLoginLogs(@Nonnull Long userId, int pageNumber,
            int pageSize);
