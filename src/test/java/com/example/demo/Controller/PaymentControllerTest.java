...
class PaymentControllerTest {
    ...
    @Mock OrganizerRefundService organizerRefundService;
    ...
    @Test void organizerRefundEndpointsDelegate() {
        PaymentController controller = new PaymentController(
                service,
                vendorRefundService,
                organizerRefundService,
                "https://front.test");
        OrganizerRefundRequest request = new OrganizerRefundRequest();
        controller.reviewOrganizerRefund("Bearer token", request);
        controller.retryOrganizerRefundPayment("Bearer token", request);
        verify(organizerRefundService).reviewRefund("Bearer token", request);
        verify(organizerRefundService).retryRefundPayment("Bearer token", request);
    }
